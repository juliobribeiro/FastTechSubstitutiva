...
public class ItemCardapioApplicationService(
    IItemCardapioService ItemCardapioService, 
    IMapper mapper) : Interfaces.IItemCardapioApplicationService
{
    ...
    public async Task<ItemCardapio> Add(BasicItemCardapio model)
    {
      ...
      //  await _publishEndpoint.Publish<MSG.BasicItemCardapio>(model);
    ...
    public async Task<ItemCardapio> Update(ItemCardapio model)
    {
     ...
     //   await _publishEndpoint.Publish<MSG.ItemCardapio>(model);
